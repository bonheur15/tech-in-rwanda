...
var contracts = []contract{
	...
	{"createPost", "POST", "/posts"}, {"getDraft", "GET", "/draft"}, {"saveDraft", "PUT", "/draft"}, {"updateMetadata", "PATCH", "/metadata"}, {"checkpoint", "POST", "/checkpoint"}, {"submit", "POST", "/submit"}, {"publish", "POST", "/publish"}, {"fork", "POST", "/fork"}, {"attachMedia", "POST", "/media/"}, {"unsetFeaturedImage", "DELETE", "/featured-image"}, {"versions", "GET", "/versions"}, {"restore", "POST", "/restore/"}, {"deletePost", "DELETE", "/posts/"},
